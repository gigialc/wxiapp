    ...
    <div className="flex flex-col items-center justify-center min-h-screen py-2 mb-10">
      ...
      <main className="flex flex-col items-center justify-center flex-1 text-center px-4 sm:px-20 mt-20">
        ...
        <div className="mt-16 text-center px-4 sm:px-20">
          <p className="text-sm sm:text-xl font-semibold text-gray-900 dark:text-white">
          ...
          <p className="mt-8 text-sm sm:text-xl text-gray-900 dark:text-white">
        ...
        <div className="mt-40 text-center px-4 sm:px-20">
          ...
          <p className="mt-4 text-lg sm:text-3xl font-bold text-gray-900 dark:text-white">
        ...
        <div className="flex flex-wrap justify-around w-full mt-16 px-4 sm:px-20 mb-40">
          <div className="text-center w-full sm:w-80 p-6">
            ...
            />
            <h3 className="text-xl sm:text-2xl font-bold mt-4">Slack Channel</h3>
          ...
          <div className="text-center w-full sm:w-80 p-6">
            <Image
              ...
              className="mx-auto" // Centers the image horizontally within its container
            />
            <h3 className="text-xl sm:text-2xl font-bold mt-4">In person events</h3>
            <p className="text-sm sm:text-base text-gray-700 dark:text-white">
          ...
          <div className="text-center w-full sm:w-80 p-6">
            <Image
              ...
              className="mx-auto" // Centers the image horizontally within its container
            />
            <h3 className="text-xl sm:text-2xl font-bold mt-4">Resources</h3>
            <p className="text-sm sm:text-base text-gray-700 dark:text-white">
